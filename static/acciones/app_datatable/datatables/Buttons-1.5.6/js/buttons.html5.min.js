        ...
        className: "buttons-copy buttons-html5", text: function (a) {
            ...
            if (p.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (k) {
                        b.buttons.info(b.i18n("buttons.copyTitle", "Registros Copiados"), b.i18n("buttons.copySuccess", {
                            1: "Copiada 1 fila exitosamente",
                            _: "Copiadas %d filas exitosamente"
                        }, a.rows), 2E3);
                        this.processing(!1);
                        return
                    }
            ...
            k = f("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") +
                "</span>").append(d);
            b.buttons.info(b.i18n("buttons.copyTitle", "Registros Copiados"), k, 0);
            c[0].focus();
            c[0].select();
